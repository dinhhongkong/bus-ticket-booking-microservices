...
public class VNPayService {
    ...
    public int orderReturn(HttpServletRequest request){
        ...
        int invoiceId = extractId(request.getParameter("vnp_OrderInfo"));
    ...
    private int extractId(String s) {
        // Loại bỏ phần tiền tố "invoice id "
        String idString = s.replace("invoice id ", "");
        // Chuyển chuỗi còn lại thành số nguyên
